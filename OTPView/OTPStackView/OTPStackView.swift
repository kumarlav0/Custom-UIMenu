...
class OTPStackView: UIStackView {
    ...
    // Colors
    let inactiveFieldBorderColor = #colorLiteral(red: 0.1764705926, green: 0.4980392158, blue: 0.7568627596, alpha: 1)
    //UIColor(named: "ThemeColor")
    let textBackgroundColor = #colorLiteral(red: 0.9098039216, green: 0.168627451, blue: 0.168627451, alpha: 1)
    //UIColor(named: "ThemeColor")
    let activeFieldBorderColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    //UIColor(named: "ThemeColor")
    ...
    private final func checkForValidity() {
        for fields in textFieldsCollection where fields.text?.trimmingCharacters(in: CharacterSet.whitespaces) == "" {
